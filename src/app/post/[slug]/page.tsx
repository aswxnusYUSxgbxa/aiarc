    ...
    <div className="min-h-screen bg-white selection:bg-indigo-100 selection:text-indigo-900">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        <article>
          ...
          <div className="prose prose-lg sm:prose-xl lg:prose-2xl mx-auto prose-slate prose-indigo prose-headings:font-bold prose-a:text-indigo-600 hover:prose-a:text-indigo-500" dangerouslySetInnerHTML={{ __html: post.content }} />
        </article>
      </main>
